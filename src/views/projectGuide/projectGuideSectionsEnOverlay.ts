...
> = {
	...
	'pg-s13-8': {
		title: '13.8 English-learning Agent (multi-session History isolation: the drawer only lists English-learning Agent sessions and does not mix in knowledge-assistant Skill chats or Skill try-run sessions.)',
		description:
